# Информационная система «КосмоСкан»
...
6. **Полная контейнеризация:** Написаны оптимизированные Dockerfile на базе легковесного дистрибутива `eclipse-temurin:21-jre-alpine` и оркестрационный файл `docker-compose.yml`, разворачивающий систему одной командой.
